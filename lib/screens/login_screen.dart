...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      // Clear ONLY the student profile cache so the correct section is
      // always fetched fresh for whoever just logged in.
      // The content cache (videos/books) is intentionally kept — it is
      // always filtered by the freshly-loaded section before being shown,
      // so content never disappears on re-login even offline.
