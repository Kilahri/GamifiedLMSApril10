...
import 'package:elearningapp_flutter/screens/teacher/teacher_student_analytics_screen.dart';
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildSettingsTile(
            ...
            subtitle: "View student performance across all games and reading",
            onTap:
                () => Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder:
                        (_) => TeacherStudentAnalyticsScreen(
                          teacherUsername: _currentUsername,
                        ),
                  ),
                ),
          ),
          ...
          _buildSettingsTile(
            ...
            onTap: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder:
                      (context) => TeacherGuidelinesScreen(
                        currentUsername: _currentUsername,
                      ),
                ),
              );
